function init(){
    ...
    const backgrounds = [
        'radial-gradient(#0c353e, #000000)', 'radial-gradient(#db0083, #060005)', 'radial-gradient(#a9b9b8, #111214)'
    ];
    ...
    document.addEventListener('touchmove', throttle(scrollChange, 1500)) //for mobile
    ...
    tl.to(navOpen, 0.5, {y:0})
        ...
        .fromTo(navlogo, 0.2, {color: 'white'}, {color: 'black'},'-=1')
